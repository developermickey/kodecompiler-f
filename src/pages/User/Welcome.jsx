        ...
        <div className="relative max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-end gap-6 text-white">
          <div>
            ...
            <p className="text-lg text-blue-100 max-w-xl leading-relaxed">
              Your compiler is ready. You have <span className="font-bold text-white">3 pending recommendations</span> and your streak is active.
            </p>
          </div>
          ...
          <div className="flex gap-4">
             {stats.map((stat, i) => (
               <div key={i} className="hidden md:block text-center px-4 py-2 rounded-lg bg-blue-800/30 border border-blue-400/30 backdrop-blur-sm">
            ...
            <div>
              <div className="flex items-center justify-between mb-4 px-1">
                 <h2 className="text-lg font-bold text-gray-900 flex items-center gap-2">
                    <TrendingUp className="w-5 h-5 text-[#0652e9]" /> Recommended Problems
                 </h2>
                 <button className="text-sm font-semibold text-[#0652e9] hover:underline">View All</button>
              </div>
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                {recommendations.length > 0 ? (
                  ...
                  <div className="col-span-2 text-center py-12 bg-white rounded-xl border border-dashed border-gray-300 text-gray-500">
                    No recommendations yet. Start solving to get personalized picks!
                  </div>
                )}
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-lg shadow-gray-200/50 border border-gray-100 p-6 relative overflow-hidden">
               ...
               <div className="relative z-10">
                 ...
                 <div className="flex justify-between items-end mb-2">
                    <span className="text-3xl font-extrabold text-[#0652e9]">3<span className="text-lg text-gray-400 font-medium">/5</span></span>
               ...
               <div className="flex items-start gap-3">
                  ...
                  <div>
                     ...
                     <p className="text-xs text-blue-100 mt-1 leading-relaxed">
                        Solving "Hard" problems gives you 2x more ranking points than Medium ones.
                     </p>
                  </div>
               </div>
            </div>
