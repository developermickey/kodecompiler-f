...
const Login = ({ isModal = false, wallTitle = "", wallMessage = "" }) => {
  ...
  const { isLoading, error, success, user, otpSent, verifyingOTP } =
  ...
  // --- UI HELPERS ---
  const displayTitle = wallTitle ? wallTitle : "Welcome back";
    ...
    <div className="w-full max-w-[400px] mx-auto">
        ...
        >
          ...
          <div className="space-y-1">
            <div className="flex justify-between items-center">
              ...
              <NavLink
                to="/forgot-password"
                className="text-xs font-semibold text-[#0652e9] hover:text-blue-700"
              >
                Forgot password?
              </NavLink>
            </div>
      ...
      {authMethod === "otp" && (
        ...
        >
          <div className="space-y-1">
            ...
            <div className="relative group">
              <Mail
                className={`absolute left-3 top-1/2 -translate-y-1/2 h-5 w-5 transition-colors ${otpSent ? "text-gray-300" : "text-gray-400 group-focus-within:text-[#0652e9]"}`}
              />
              <input
                type="email"
                required
          ...
          <div
            className={`transition-all duration-500 ease-in-out overflow-hidden ${otpSent ? "max-h-32 opacity-100" : "max-h-0 opacity-0"}`}
          >
      ...
      {!isModal && (
        <p className="mt-8 text-center text-sm text-gray-600">
          ...
          <NavLink
            to="/register"
            className="font-bold text-[#0652e9] hover:text-blue-700 transition-colors"
          >
            Sign up
          </NavLink>
        </p>
  ...
  if (isModal) {
    return <div className="bg-white p-2 w-full">{LoginFormContent}</div>;
  }
