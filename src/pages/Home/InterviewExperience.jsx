        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="order-2 lg:order-1">
            ...
            <p className="text-lg text-gray-600 mb-8 leading-relaxed">
              ...
              strategies, and mistakes that helped them grow. Gain insights into
              what companies look for, how interviews are structured, and how
              you can prepare more effectively for your own opportunities.
            </p>
