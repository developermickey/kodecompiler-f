        ...
        <div className="text-center max-w-6xl mx-auto">
         ...
         <div className="inline-flex items-center px-4 py-2 bg-blue-50 border border-blue-200 rounded-full mb-6">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-gray-900 mb-6 leading-tight">
            <span className="text-[#0652e9]">Master</span> the next
            generation  <br />
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 max-w-5xl mx-auto">
            {features.map((feature, index) => (
              <div
                key={index}
                className="bg-white border border-gray-200 rounded-xl p-6 hover:shadow-lg hover:border-green-300 transition-all duration-200 group"
              >
                <feature.icon className="w-8 h-8 text-green-500 mb-3 mx-auto group-hover:scale-110 transition-transform duration-200" />
          ...
          <div className="mt-16 pt-12 border-t border-gray-200">
            ...
            <div className="flex flex-wrap items-center justify-center gap-8 md:gap-12 opacity-60 grayscale hover:grayscale-0 hover:opacity-100 transition-all duration-300">
              <span className="text-2xl md:text-3xl font-bold text-gray-700">Google</span>
              <span className="text-2xl md:text-3xl font-bold text-gray-700">Meta</span>
              <span className="text-2xl md:text-3xl font-bold text-gray-700">Amazon</span>
              <span className="text-2xl md:text-3xl font-bold text-gray-700">Microsoft</span>
              <span className="text-2xl md:text-3xl font-bold text-gray-700">Apple</span>
            </div>
          </div>
        </div>
      </div>
